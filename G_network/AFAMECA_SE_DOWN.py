...
class AFAMECA_SE_DOWN(nn.Module):
    "在UNet加入AFAM，自适应特征注意力融合，密集跳跃连接的一种表现形式"
    def __init__(self,in_channels,out_channels):
        super(AFAMECA_SE_DOWN,self).__init__()
        ...
        self.selay1 = SELayer(32)
        self.selay2 = SELayer(64)
        self.selay3 = SELayer(128)
